...
# Sensor Kinematics
  ...
  if (isens == 1): 
    ...
    OMcp1_17 = OMcp1_16+ROcp1_16*qd[8]
    OMcp1_27 = OMcp1_26+ROcp1_26*qd[8]
    OMcp1_37 = OMcp1_36+ROcp1_36*qd[8]
    ...
    OPcp1_17 = OPcp1_16+ROcp1_16*qdd[8]+qd[8]*(OMcp1_26*ROcp1_36-OMcp1_36*ROcp1_26)
    OPcp1_27 = OPcp1_26+ROcp1_26*qdd[8]+qd[8]*(-OMcp1_16*ROcp1_36+OMcp1_36*ROcp1_16)
    OPcp1_37 = OPcp1_36+ROcp1_36*qdd[8]+qd[8]*(OMcp1_16*ROcp1_26-OMcp1_26*ROcp1_16)
    ...
    OMcp1_18 = OMcp1_17+ROcp1_16*qd[9]
    OMcp1_28 = OMcp1_27+ROcp1_26*qd[9]
    OMcp1_38 = OMcp1_37+ROcp1_36*qd[9]
    ...
    OPcp1_18 = OPcp1_17+ROcp1_16*qdd[9]+qd[9]*(OMcp1_27*ROcp1_36-OMcp1_37*ROcp1_26)
    OPcp1_28 = OPcp1_27+ROcp1_26*qdd[9]+qd[9]*(-OMcp1_17*ROcp1_36+OMcp1_37*ROcp1_16)
    OPcp1_38 = OPcp1_37+ROcp1_36*qdd[9]+qd[9]*(OMcp1_17*ROcp1_26-OMcp1_27*ROcp1_16)
    ...
    OMcp1_19 = OMcp1_18+ROcp1_49*qd[10]
    OMcp1_29 = OMcp1_28+ROcp1_59*qd[10]
    OMcp1_39 = OMcp1_38+ROcp1_69*qd[10]
    ...
    OPcp1_19 = OPcp1_18+ROcp1_49*qdd[10]+qd[10]*(OMcp1_28*ROcp1_69-OMcp1_38*ROcp1_59)
    OPcp1_29 = OPcp1_28+ROcp1_59*qdd[10]+qd[10]*(-OMcp1_18*ROcp1_69+OMcp1_38*ROcp1_49)
    OPcp1_39 = OPcp1_38+ROcp1_69*qdd[10]+qd[10]*(OMcp1_18*ROcp1_59-OMcp1_28*ROcp1_49)
  ...
  if (isens == 2): 
    ...
    OMcp2_19 = OMcp2_18+ROcp2_413*qd[14]
    OMcp2_29 = OMcp2_28+ROcp2_513*qd[14]
    OMcp2_39 = OMcp2_38+ROcp2_613*qd[14]
    ...
    OPcp2_19 = OPcp2_18+ROcp2_413*qdd[14]+qd[14]*(OMcp2_28*ROcp2_613-OMcp2_38*ROcp2_513)
    OPcp2_29 = OPcp2_28+ROcp2_513*qdd[14]+qd[14]*(-OMcp2_18*ROcp2_613+OMcp2_38*ROcp2_413)
    OPcp2_39 = OPcp2_38+ROcp2_613*qdd[14]+qd[14]*(OMcp2_18*ROcp2_513-OMcp2_28*ROcp2_413)
  ...
  if (isens == 3): 
    ...
    OMcp3_17 = OMcp3_16+ROcp3_16*qd[21]
    OMcp3_27 = OMcp3_26+ROcp3_26*qd[21]
    OMcp3_37 = OMcp3_36+ROcp3_36*qd[21]
    ...
    OPcp3_17 = OPcp3_16+ROcp3_16*qdd[21]+qd[21]*(OMcp3_26*ROcp3_36-OMcp3_36*ROcp3_26)
    OPcp3_27 = OPcp3_26+ROcp3_26*qdd[21]+qd[21]*(-OMcp3_16*ROcp3_36+OMcp3_36*ROcp3_16)
    OPcp3_37 = OPcp3_36+ROcp3_36*qdd[21]+qd[21]*(OMcp3_16*ROcp3_26-OMcp3_26*ROcp3_16)
    ...
    OMcp3_18 = OMcp3_17+ROcp3_16*qd[22]
    OMcp3_28 = OMcp3_27+ROcp3_26*qd[22]
    OMcp3_38 = OMcp3_37+ROcp3_36*qd[22]
    ...
    OPcp3_18 = OPcp3_17+ROcp3_16*qdd[22]+qd[22]*(OMcp3_27*ROcp3_36-OMcp3_37*ROcp3_26)
    OPcp3_28 = OPcp3_27+ROcp3_26*qdd[22]+qd[22]*(-OMcp3_17*ROcp3_36+OMcp3_37*ROcp3_16)
    OPcp3_38 = OPcp3_37+ROcp3_36*qdd[22]+qd[22]*(OMcp3_17*ROcp3_26-OMcp3_27*ROcp3_16)
    ...
    OMcp3_19 = OMcp3_18+ROcp3_422*qd[23]
    OMcp3_29 = OMcp3_28+ROcp3_522*qd[23]
    OMcp3_39 = OMcp3_38+ROcp3_622*qd[23]
    OPcp3_19 = OPcp3_18+ROcp3_422*qdd[23]+qd[23]*(OMcp3_28*ROcp3_622-OMcp3_38*ROcp3_522)
    OPcp3_29 = OPcp3_28+ROcp3_522*qdd[23]+qd[23]*(-OMcp3_18*ROcp3_622+OMcp3_38*ROcp3_422)
    OPcp3_39 = OPcp3_38+ROcp3_622*qdd[23]+qd[23]*(OMcp3_18*ROcp3_522-OMcp3_28*ROcp3_422)
    OMcp3_110 = OMcp3_19+ROcp3_723*qd[24]
    OMcp3_210 = OMcp3_29+ROcp3_823*qd[24]
    OMcp3_310 = OMcp3_39+ROcp3_923*qd[24]
    OPcp3_110 = OPcp3_19+ROcp3_723*qdd[24]+qd[24]*(OMcp3_29*ROcp3_923-OMcp3_39*ROcp3_823)
    OPcp3_210 = OPcp3_29+ROcp3_823*qdd[24]+qd[24]*(-OMcp3_19*ROcp3_923+OMcp3_39*ROcp3_723)
    OPcp3_310 = OPcp3_39+ROcp3_923*qdd[24]+qd[24]*(OMcp3_19*ROcp3_823-OMcp3_29*ROcp3_723)
    ...
    OMcp3_111 = OMcp3_110+ROcp3_424*qd[25]
    OMcp3_211 = OMcp3_210+ROcp3_524*qd[25]
    OMcp3_311 = OMcp3_310+ROcp3_624*qd[25]
    ...
    OPcp3_111 = OPcp3_110+ROcp3_424*qdd[25]+qd[25]*(OMcp3_210*ROcp3_624-OMcp3_310*ROcp3_524)
    OPcp3_211 = OPcp3_210+ROcp3_524*qdd[25]+qd[25]*(-OMcp3_110*ROcp3_624+OMcp3_310*ROcp3_424)
    OPcp3_311 = OPcp3_310+ROcp3_624*qdd[25]+qd[25]*(OMcp3_110*ROcp3_524-OMcp3_210*ROcp3_424)
  ...
  if (isens == 4): 
    ...
    OMcp4_17 = OMcp4_16+ROcp4_16*qd[27]
    OMcp4_27 = OMcp4_26+ROcp4_26*qd[27]
    OMcp4_37 = OMcp4_36+ROcp4_36*qd[27]
    ...
    OPcp4_17 = OPcp4_16+ROcp4_16*qdd[27]+qd[27]*(OMcp4_26*ROcp4_36-OMcp4_36*ROcp4_26)
    OPcp4_27 = OPcp4_26+ROcp4_26*qdd[27]+qd[27]*(-OMcp4_16*ROcp4_36+OMcp4_36*ROcp4_16)
    OPcp4_37 = OPcp4_36+ROcp4_36*qdd[27]+qd[27]*(OMcp4_16*ROcp4_26-OMcp4_26*ROcp4_16)
    ...
    OMcp4_18 = OMcp4_17+ROcp4_16*qd[28]
    OMcp4_28 = OMcp4_27+ROcp4_26*qd[28]
    OMcp4_38 = OMcp4_37+ROcp4_36*qd[28]
    ...
    OPcp4_18 = OPcp4_17+ROcp4_16*qdd[28]+qd[28]*(OMcp4_27*ROcp4_36-OMcp4_37*ROcp4_26)
    OPcp4_28 = OPcp4_27+ROcp4_26*qdd[28]+qd[28]*(-OMcp4_17*ROcp4_36+OMcp4_37*ROcp4_16)
    OPcp4_38 = OPcp4_37+ROcp4_36*qdd[28]+qd[28]*(OMcp4_17*ROcp4_26-OMcp4_27*ROcp4_16)
    ...
    OMcp4_19 = OMcp4_18+ROcp4_428*qd[29]
    OMcp4_29 = OMcp4_28+ROcp4_528*qd[29]
    OMcp4_39 = OMcp4_38+ROcp4_628*qd[29]
    OPcp4_19 = OPcp4_18+ROcp4_428*qdd[29]+qd[29]*(OMcp4_28*ROcp4_628-OMcp4_38*ROcp4_528)
    OPcp4_29 = OPcp4_28+ROcp4_528*qdd[29]+qd[29]*(-OMcp4_18*ROcp4_628+OMcp4_38*ROcp4_428)
    OPcp4_39 = OPcp4_38+ROcp4_628*qdd[29]+qd[29]*(OMcp4_18*ROcp4_528-OMcp4_28*ROcp4_428)
    OMcp4_110 = OMcp4_19+ROcp4_729*qd[30]
    OMcp4_210 = OMcp4_29+ROcp4_829*qd[30]
    OMcp4_310 = OMcp4_39+ROcp4_929*qd[30]
    OPcp4_110 = OPcp4_19+ROcp4_729*qdd[30]+qd[30]*(OMcp4_29*ROcp4_929-OMcp4_39*ROcp4_829)
    OPcp4_210 = OPcp4_29+ROcp4_829*qdd[30]+qd[30]*(-OMcp4_19*ROcp4_929+OMcp4_39*ROcp4_729)
    OPcp4_310 = OPcp4_39+ROcp4_929*qdd[30]+qd[30]*(OMcp4_19*ROcp4_829-OMcp4_29*ROcp4_729)
    ...
    OMcp4_111 = OMcp4_110+ROcp4_430*qd[31]
    OMcp4_211 = OMcp4_210+ROcp4_530*qd[31]
    OMcp4_311 = OMcp4_310+ROcp4_630*qd[31]
    ...
    OPcp4_111 = OPcp4_110+ROcp4_430*qdd[31]+qd[31]*(OMcp4_210*ROcp4_630-OMcp4_310*ROcp4_530)
    OPcp4_211 = OPcp4_210+ROcp4_530*qdd[31]+qd[31]*(-OMcp4_110*ROcp4_630+OMcp4_310*ROcp4_430)
    OPcp4_311 = OPcp4_310+ROcp4_630*qdd[31]+qd[31]*(OMcp4_110*ROcp4_530-OMcp4_210*ROcp4_430)
    ...
    sens.P[2] = POcp4_211
    sens.P[3] = POcp4_311
    sens.R[1,1] = ROcp4_131
    sens.R[1,2] = ROcp4_231
    sens.R[1,3] = ROcp4_331
    sens.R[2,1] = ROcp4_430
    sens.R[2,2] = ROcp4_530
    sens.R[2,3] = ROcp4_630
    sens.R[3,1] = ROcp4_731
    sens.R[3,2] = ROcp4_831
    sens.R[3,3] = ROcp4_931
    sens.V[1] = VIcp4_111
    sens.V[2] = VIcp4_211
    sens.V[3] = VIcp4_311
    sens.OM[1] = OMcp4_111
